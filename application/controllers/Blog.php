...
class Blog extends CI_Controller {
    ...
    {
        $data['posts'] = $this->m_db->get_posts(1000, $start);
    ...
    function new_post()//Creating new post page
    {
        ...
        if ($this->input->post()) {
           ...
           exit();
            ...
            $data = array('post_title' => $this->input->post('post_title'), 'post' => $this->input->post('post'), 'image' => $config['upload_path'].$fdata['file_name'], 'active' => 1,);
